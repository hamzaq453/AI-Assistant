from PyQt5.QtWidgets import (QApplication, QMainWindow, QWidget, QStackedWidget, 
                            QLineEdit, QGridLayout, QVBoxLayout, QPushButton, 
                            QFrame, QLabel, QSizePolicy, QTextEdit, QHBoxLayout)
from PyQt5.QtGui import (QColor, QPalette, QTextCharFormat, QFont, QPixmap, 
                        QTextBlockFormat, QIcon, QPainter, QMovie)
...
current_dir = os.path.dirname(os.path.abspath(__file__))  # Get the directory containing GUI.py
TempDirPath = os.path.join(current_dir, "Files")
GraphicsDirPath = os.path.join(current_dir, "Graphics")

# Create necessary directories and files
for directory in [TempDirPath, GraphicsDirPath]:
...
old_chat_message = ""  # Add this global variable
...
class ChatSection(QWidget):
    def __init__(self):
        ...
        layout.setStretchFactor(self.chat_text_edit, 1)
        ...
        self.timer.timeout.connect(self.SpeechRecognogText)
        self.timer.start(5)
